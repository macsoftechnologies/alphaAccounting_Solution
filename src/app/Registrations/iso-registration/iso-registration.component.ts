...
@Component({
  selector: "app-iso-registration",
  templateUrl: "./iso-registration.component.html",
  styleUrls: ["./iso-registration.component.scss"],
})
export class ISORegistrationComponent implements OnInit {
  type: any;
  checkboxVal: string = "";
  public CompanyForm;
  public DirectorForm;
