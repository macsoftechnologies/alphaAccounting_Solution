...
@Component({
  selector: "app-digital-signature-registration",
  templateUrl: "./digital-signature-registration.component.html",
  styleUrls: ["./digital-signature-registration.component.scss"],
})
export class DigitalSignatureRegistrationComponent implements OnInit {
  type: any;
  checkboxVal: string = "";
  public CompanyForm;
  public DirectorForm;
